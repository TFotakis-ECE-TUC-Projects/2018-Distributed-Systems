"""
Django settings for StorageService project.
...
SECRET_KEY = 'l(y)1rl8se@cm!@+22l)2^&b^lyfw@5jsnt%ja6mrjwnplg*re'
...
ROOT_URLCONF = 'StorageService.urls'
...
WSGI_APPLICATION = 'StorageService.wsgi.application'
